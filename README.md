...
_A minimal CLI tool for encrypting and decrypting files and folders using a password — built with Python and powered by [cryptography](https://github.com/pyca/cryptography)_

![Showcase](https://raw.githubusercontent.com/kalebe16/hideit/main/showcase.png)
...
You can also download platform-specific executables directly from the [Releases page](https://github.com/Kalebe16/hideit/releases)
...
```bash
pip install --upgrade hideit
```

## How to uninstall (pip installations only)
```bash
pip uninstall hideit
```
